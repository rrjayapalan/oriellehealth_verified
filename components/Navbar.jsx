      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center h-20 gap-4">
          ...
          <a
            ...
            className="flex-shrink-0 bg-gold text-white px-4 py-2 rounded-lg shadow-md hover:shadow-lg hover:opacity-90 transition text-sm md:text-base whitespace-nowrap"
          >
            WhatsApp Us
          </a>
        </div>
